...
{
    public class C_Layanan : Connector
    {
        C_Homepage Controller;
        V_TambahLayanan tambahLayanan;

        public C_Layanan(C_Homepage controller, V_TambahLayanan view)
        {
        ...
        public List<M_Layanancs> GetDataLayanan()
        {
            List<M_Layanancs> dtlayanan = new List<M_Layanancs>();
            DataTable query = Execute_With_Return("SELECT Id_Layanan, Nama_Layanan, Harga_Layanan FROM Data_Layanan");
            foreach (DataRow row in query.Rows)
            {
                M_Layanancs m_layanan = new M_Layanancs
                {
